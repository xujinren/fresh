    ...
    <div id="top_t">
        ...
        <div id="photo_info" class="fr">
            <div id="photo" class="fl">
                <a href="#"><img src="../../images/logo02.png" alt="源辰信息" width="60" height="60"></a>
            </div>
...
<div class="side">
    <div class="sideMenu" id="sideMenu" style="margin:0 auto">
     <h3>管理员信息</h3>
        <ul>
            <li><a href="javascript:void(0)" onclick="showpage(this,'page/type.html')">管理员信息管理</a></li>
        </ul>
    
        <h3>商品信息</h3>
        <ul>
            <li><a href="javascript:void(0)" onclick="showpage(this,'page/type2.html')">商品类型管理</a></li>
            <li><a href="javascript:void(0)" onclick="showpage(this,'page/goods.html')">商品信息管理</a></li>
            <li><a href="javascript:void(0)" onclick="showpage(this,'page/views.html')">商品信息浏览</a></li>
        </ul>
        ...
        <h3>个人中心</h3>
        <ul>
            <li><a href="javascript:void(0)" onclick="showpage(this,'')">个人信息</a></li>
            <li><a href="javascript:void(0)" onclick="showpage(this,'')">修改密码</a></li>
        </ul>
    </div>
</div>
<div class="main">
