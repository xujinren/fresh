...
public class MenberInfo implements Serializable {
	private static final long serialVersionUID = -7810563650797354227L;
	private int mno;
	...
	public MenberInfo(int mno, String nickName, String realName, String pwd, String tel, String email, String photo,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MenberInfo other = (MenberInfo) obj;
		if (email == null) {
			if (other.email != null)
				return false;
